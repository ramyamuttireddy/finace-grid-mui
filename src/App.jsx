...
import FourCrads from './fourcrads';
    ...
    <>
      <Container maxWidth="xl" className='w-full lg:max-w-7xl h-full'>
        ...
        <Box className="grid grid-cols-1 lg:grid-cols-5" >
          ...
          <Box className="bg-black  col-span-1  text-white flex flex-col justify-between pt-[40px] rounded-[0_16px_16px_0]">

            <Box>
              <img src="/assets/finance.svg" alt="" className='ml-[40px] mb-[32px] ' />
          ...
          <Box className="bg-[#F8F4F0] col-span-4 p-[32px_40px]">
